            ...
            <div className="container mx-auto px-6 py-9">
                <div className="flex flex-col mt-4">
                    ...
                    <div className="flex flex-row justify-center my-10 space-x-4">
                        <Link target="_blank" href="https://www.linkedin.com/in/kaviruhapuarachchi/">
                            <div className="text-sm hover:text-black dark:hover:text-white text-gray-400 dark:text-gray-500 text-center">LinkedIn</div>
                        </Link>
                    ...
                    <p className="text-sm text-slate-300 dark:text-slate-500 hover:text-indigo-300 dark:hover:text-indigo-500 text-center">
                        © {new Date().getFullYear()} kaviruh. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
